...
function ScienceFiction(){
    ...
    useEffect(()=>{
        const fetchBooks=async()=>{
          try{
            const response= await axios.get(`https://www.googleapis.com/books/v1/volumes?q=subject:science-fiction&maxResults=${booksPerPage}&startIndex=${(currentPage - 1) * booksPerPage}`)
